...
def test_manifest_is_canonical_and_binds_every_required_input() -> None:
    ...
    assert [entry["path"] for entry in wrapper["source_inputs"]] == [
        ...
        "mvp/runtime-hosts/goose-host-v2/src/host.rs",
        "mvp/runtime-hosts/goose-host-v2/src/live.rs",
        ...
        "mvp/runtime-hosts/goose-host-v2/src/native_agent.rs",
        "mvp/runtime-hosts/goose-host-v2/src/tool_transport.rs",
    ]
