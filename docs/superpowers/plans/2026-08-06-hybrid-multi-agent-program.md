...
**Goal:** Deliver the approved hybrid multi-Agent Workbench as five sequential, independently testable batches.

**Architecture:** Workbench remains the durable control plane and runs isolated Hermes Agent runtimes as the execution plane. Model, Skill, tool, connector, AG-UI, and Artifact capabilities are exposed through narrow versioned interfaces.
...
3. [Batch 3 — Free-form Multi-Agent Teams](2026-08-06-batch-3-multi-agent-teams.md)
4. [Batch 4 — Artifacts and Real Tools](2026-08-06-batch-4-artifacts-and-tools.md)
5. [Batch 5 — Supervisor, Recovery, and Release Gate](2026-08-06-batch-5-supervisor-recovery.md)
